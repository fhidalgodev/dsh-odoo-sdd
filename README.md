...
```bash
npm install dsh-odoo-sdd        # 0.1.2, published with a provenance attestation
```
...
- insert:
    - id: odoo-sdd
      config:
        ...
        methodAllowlist: []     # "model.method" pairs a batch may call (any model)
